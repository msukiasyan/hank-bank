...
toc;
tic;
% paths               = transition_Nshock(options, params, sol, stats, stats.NW * 0.95);
toc;
return
...
% cs_theta_bank       = comp_stat(options, params, 'theta_bank', 0.48, 0.52, 5);
% cs_f_bank           = comp_stat(options, params, 'f_bank', params.f_bank * 0.95, params.f_bank * 1.05, 5);
% cs_rho              = comp_stat(options, params, 'rho', params.rho * 0.95, params.rho * 1.05, 5);
% cs_rho_bank         = comp_stat(options, params, 'rho_bank', params.rho_bank * 0.95, params.rho_bank * 1.05, 5);
% cs_chi0             = comp_stat(options, params, 'chi0', params.chi0 * 0.95, params.chi0 * 1.05, 5);
% cs_Aprod            = comp_stat(options, params, 'Aprod', params.Aprod * 0.95, params.Aprod * 1.05, 5);
toc;
